...
public class MonthvalueDemo {
	...
	public void m1() throws InterruptedException {
		...
		WebElement rowval = table.findElement(By.xpath("/html/body/table/tbody//child::tr[3]//following-sibling::td[1]"));
	
		String rowTextMonth = rowval.getText();
		System.out.println("Rowtext is " + rowTextMonth);

		WebElement value = table.findElement(By.xpath("/html/body/table/tbody//child::tr[3]/child::td[2]"));
