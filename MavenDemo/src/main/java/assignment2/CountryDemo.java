package assignment2;
	...
	@Test
		public void m1() throws InterruptedException {
			...
			WebElement rowvalue = table.findElement(By.xpath("/html/body/table/tbody//child::tr[5]//following-sibling::td[3]"));
			String rowText=rowvalue.getText();
			System.out.println("Rowtext is "+rowText);
		
			
			WebElement columnvalue=driver.findElement(By.xpath("/html/body/table/tbody//child::tr[5]//child::td[1]"));
